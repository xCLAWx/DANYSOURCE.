...
if MsgText[2] == "ردود داني"   then return unlock_replay(msg) end
if MsgText[2] == "الاذاعه"  then return unlock_brod(msg) end
if MsgText[2] == "ايدي داني"   then return unlock_IID(msg) end
if MsgText[2] == "ترحيب داني"  then return unlock_Welcome(msg) end
...
if MsgText[2] == "ردود داني"   then return lock_replay(msg) end
if MsgText[2] == "الاذاعه"  then return lock_brod(msg) end
if MsgText[2] == "ايدي داني"   then return lock_IID(msg) end
if MsgText[2] == "ترحيب داني"  then return lock_Welcome(msg) end
...
sendMsg(msg.chat_id_,msg.id_,'↫ عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس داني يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n❗️')
end  
else
...
send_key(msg.sender_user_id_,'  [-قناة سورس : داني ل](https://t.me/DannyySource)',nil,inline,msg.id_)
return false
end
...
local colors = {'blue','green','yellow','magenta','ODannyySourcee','DarkODannyySourcee','red'}
...
elseif Text== "مطور السورس" then return sendMsg(msg.chat_id_,msg.id_,"[ســونــيك ᪤ ](t.me/Soonicxx")
elseif Text== "مالك السورس" then return sendMsg(msg.chat_id_,msg.id_,"[ســونــيك ᪤](t.me/Soonicxx")
